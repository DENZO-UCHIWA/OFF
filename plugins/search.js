...
if(n && n[0]){
   ...
   let buttonMessage = {}
    ...
    const res = await axios.get("https://www.google.com/search?q=", { headers: headers, params: params });
    let body = res.data;
...
smd({
    ...
    async(message, text) => {
if(!text) return await message.reply('Give Me Number without + sign. Example: .nowa 244956100349')
