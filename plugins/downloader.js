...
`;
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "BLAST-MD tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd(
   ...
   async (message, url) => {
     try {
       ...
       if (!url) {
         return await message.reply(
           `*Uhh Please, Provide me tiktok Video Url*\n*_Ex ${prefix}tiktok https://www.tiktok.com/@dakzza/video/71505440622217_*`
         );
       }
 ...
 smd(
   ...
   async (message, url) => {
     try {
       if (!url) {
         return await message.reply(
           `*Uhh Please, Provide me tiktok Video Url*\n*_Ex ${prefix}tiktok https://www.tiktok.com/@dakuezza/video/7150544062221749531_*`
         );
       }
   ...
   async (m, url) => {
     try {
       if (!url || !url.includes("mediafire.com")) {
         return m.reply(
           `*_Provide mediafire url, Use: ${prefix}mf https://www.mediafire.com/file/i33wo2xvgvid05m/muezzaverse_22219531_musicaldown.com.mp4/file!_*`
         );
       }
       ...
       const caption = `『 *BLAST-MD • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
